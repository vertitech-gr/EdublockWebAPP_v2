...
namespace Edu_Block_dev.Migrations
{
    ...
    [Migration("20240517083912_userUniversityUserIsDeletedfalse")]
    partial class userUniversityUserIsDeletedfalse
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edu_Block.DAL.EF.EmployerToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Edu_Block.DAL.EF.PaymentOutput", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Edu_Block_dev.DAL.EF.Schema", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Edu_Block_dev.DAL.EF.Template", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Edu_Block_dev.DAL.EF.TemplateSchemaMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("TemplateSchemaMappings");
                });
            ...
            modelBuilder.Entity("Edu_Block_dev.DAL.EF.UniversityDepartmentUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("UniversityDepartmentUsers");
                });

            modelBuilder.Entity("Edu_Block_dev.DAL.EF.UniversityUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Edu_Block_dev.DAL.EF.TemplateSchemaMapping", b =>
                {
                    b.HasOne("Edu_Block_dev.DAL.EF.Schema", "Schema")
                        .WithMany()
                        .HasForeignKey("SchemaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Edu_Block_dev.DAL.EF.Template", "Template")
                        .WithMany()
